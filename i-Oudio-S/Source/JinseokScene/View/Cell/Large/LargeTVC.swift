...
class LargeTVC: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        collectionView.register(UINib(nibName: "LargeCVC", bundle: nil), forCellWithReuseIdentifier: "LargeCVC")
        // Initialization code
    }
...
extension LargeTVC : UICollectionViewDelegate{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width = UIScreen.main.bounds.width
        
        let cellWidth = width * (324/375)
        let cellHeight = cellWidth * (262/324)
...
extension LargeTVC : UICollectionViewDataSource{
